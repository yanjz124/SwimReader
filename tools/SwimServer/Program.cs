...
var serverCtx = new ServerContext
{
    ...
    LookupPoint = (ident, near, nasr) => LookupPoint(ident, near, nasr),
    LookupAirport = (code, nasr) => LookupAirport(code, nasr),
    ResolveRoute = (text, origin, dest, nasr) => ResolveRoute(text, origin, dest, nasr),
